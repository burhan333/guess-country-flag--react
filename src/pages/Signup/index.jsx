        ...
        <div className="login">
            <div className="login_body">
                <div className="login_box">
                    ...
                    <label>Name</label>
                    <input type="text" placeholder="Name" onKeyDown={(e) => handleEnter(e)} onChange={(e) => setEmail(e.target.value)} />
                    <label>Email</label>
                    ...
                    <button className={btnClass} onMouseEnter={handleHover} onClick={handleLogin} >SIGNUP</button>
                </div>
            </div>
        </div>
    )
